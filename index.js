...
app.post('/create-task',function(req,res){ //Creating a pos request to add a task into the database
...
app.get('/',function(req,res){ //This function will load the main page in which we can add and delete task
...
app.listen(port,function(err){ // This function will let us know whether the connection is sucessfull or not
    if(err){
